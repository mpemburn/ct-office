...
class Cizacl_Js extends CI_Controller {
	...
	public function cizacl()
	{
					...
					if(ui.index == 0 && !jqgrid_initialized[0]){
						...
						$("'.$jqgrid_name[2].'").jqGrid({
							...
							colModel: [ 
								...
								{name:"cizacl_rule_user_controller_id", index:"cizacl_rule_user_controller_id"},
								{name:"cizacl_rule_privilege_user_controller_id", index:"cizacl_rule_privilege_user_controller_id"},
		...
		function add_role()	{
			colorbox("/cizacl/role_add/",600,500,null,"reloadGrid");
		}
