...
class CI_{ClassName} extends CI_DataManager {
	var $request;
	...
	public function parse_request($request)
	{
		...
		$error_{ClassNameToLower} = $this->get_error_message();
		if (strlen($error_{ClassNameToLower}) > 0)
		{
			$data = array('status' => "ERROR", 'error_{ClassNameToLower}' => $error_{ClassNameToLower});
